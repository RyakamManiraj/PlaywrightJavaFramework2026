...
public class LoginTC_Json extends TestBase {
	...
	@TestDataFile(file = "src/test/resources/testdata/Login.json")
	public void testLoginWithJson(Map<String, String> data) {
